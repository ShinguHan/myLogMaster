...
from main_window import MainWindow # Renamed from previous main_window
...
class AppLauncher(QMainWindow):
    def __init__(self):
        ...
        self.sim_button = QPushButton("Open Simulator")
        self.sim_button.clicked.connect(self.open_simulator)
